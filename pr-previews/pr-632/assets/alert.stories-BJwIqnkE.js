import{i as e}from"./preload-helper-BdFrVu1K.js";import{t}from"./jsx-runtime-f3rHp9ZU.js";import{i as n,n as r,r as i,t as a}from"./alert-DvCm32RX.js";import{n as o,t as s}from"./text-input-fpxemYtK.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{r(),n(),o(),c=t(),l={title:`Components (Draft)/Alerts`,component:a,tags:[`autodocs`],argTypes:{message:{control:`text`}}},u=({status:e=`a warning`})=>(0,c.jsxs)(c.Fragment,{children:[`This is a field-level alert with `,e,` status.`]}),d=e=>`This is an optional explanation of the ${e}.`,f={to:`/`,label:`This is an external link`,isExternal:!0},p={render:e=>(0,c.jsx)(a,{...e}),args:{status:`info`,message:`Information alert`}},m={...p,name:`Information with a message and an explanation`,args:{...p.args,children:`You can also add an explanation to the alert.`}},h={...p,name:`Information with only an explanation`,args:{children:`You can also only have an explanation in the notification.`}},g={...p,name:`Information with links`,args:{...p.args,children:`This is the explanation of the alert.`,links:[{to:`/`,label:`This is a link below the explanation`},f]}},_={...p,args:{...p.args,status:`success`,message:`11 results`,links:[f],children:(0,c.jsx)(c.Fragment,{children:d(`success message`)})}},v={...p,args:{...p.args,status:`warning`,message:`No results found`,links:[f],children:(0,c.jsx)(c.Fragment,{children:d(`warning`)})}},y={...p,args:{...p.args,status:`error`,message:`Page not found`,links:[f],children:(0,c.jsx)(c.Fragment,{children:d(`error`)})}},b={...p,name:`In-progress`,args:{...p.args,status:`loading`,message:`The page is loading….`}},x=e=>e!==void 0&&[`error`,`warning`,`success`].includes(e)?e:void 0,S={render:e=>(0,c.jsxs)(`div`,{className:`m-form-field`,children:[(0,c.jsx)(s,{id:e.status,name:e.status,status:x(e.status),placeholder:`Input text`,type:`text`}),(0,c.jsx)(i,{...e})]}),name:`Success (field-level)`,args:{status:`success`,message:(0,c.jsx)(u,{status:`a success`})}},C={render:e=>(0,c.jsxs)(`div`,{className:`m-form-field`,children:[(0,c.jsx)(s,{id:e.status,name:e.status,status:x(e.status),placeholder:`Input text`,type:`text`}),(0,c.jsx)(i,{...e})]}),name:`Warning (field-level)`,args:{status:`warning`,message:(0,c.jsx)(u,{status:`a warning`})}},w={render:e=>(0,c.jsxs)(`div`,{className:`m-form-field`,children:[(0,c.jsx)(s,{id:e.status,name:e.status,status:x(e.status),placeholder:`Input text`,type:`text`}),(0,c.jsx)(i,{...e})]}),name:`Error (field-level)`,args:{status:`error`,message:(0,c.jsx)(u,{status:`an error`})}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
...
}`,...w.parameters?.docs?.source}}},T=[`Information`,`InformationWithMessageAndExplanation`,`InformationWithOnlyExplanation`,`InformationWithLinks`,`Success`,`Warning`,`Error`,`InProgress`,`SuccessFieldLevel`,`WarningFieldLevel`,`ErrorFieldLevel`]}))();export{y as Error,w as ErrorFieldLevel,b as InProgress,p as Information,g as InformationWithLinks,m as InformationWithMessageAndExplanation,h as InformationWithOnlyExplanation,_ as Success,S as SuccessFieldLevel,v as Warning,C as WarningFieldLevel,T as __namedExportsOrder,l as default};